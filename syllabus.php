<?php
$page_title = 'সিলেবাস - Apex Model School';
include 'header.php';
?>
<style>
    .page-content {
...
<div class="page-content">
    <div class="container" style=" max-width: 1050px;">
        <h1 class="page-title">সিলেবাস</h1>
        <p class="page-subtitle">সকল শ্রেণীর শিক্ষা বিষয়বস্তু ও পাঠ্যক্রম</p>
        ...
        <div class="table-container">
            <table class="table table-striped">
                ...
                <tbody>
                <?php
                $result = $conn->query("SELECT * FROM syllabus_files ORDER BY uploaded_date DESC");
                ...
                if ($result && $result->num_rows > 0) {
                    while ($file = $result->fetch_assoc()) {
                        ...
                        ?>
                        <tr>
                            <td><i class="fas <?= $icon ?>" style="font-size: 1.5rem; color: #28a745;"></i></td>
                            <td><strong><?= htmlspecialchars($file['title']) ?></strong></td>
                            <td><?= date('d M Y', strtotime($file['uploaded_date'])) ?></td>
                            <td>
                                <a href="download_file.php?id=<?= $file['id'] ?>&type=syllabus" class="btn-download">
