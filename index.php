...
<div class="main-content" style="width: 85%; margin: auto;">
<div class="popup-overlay" id="appPopup">
    <div class="popup-content">
        <div class="popup-header">
            <button class="popup-close" onclick="closePopup()"><i class="fas fa-times"></i></button>
            <img src="/apex/assets/img/logo.png" alt="Apex Model School Logo" style="width: 60px; height: 60px; border-radius: 50%; margin-bottom: 10px; background: white; padding: 3px; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
        </div>
...
<div class="main-content">
        ...
        <div class="hero-slider">
            <div class="slider-wrapper">
                <div class="slide active">
                    <img src="/apex/assets/img/photo-4.jpg" alt="School Photo">
                ...
                <div class="slide">
                    <img src="/apex/assets/img/photo-1.jpg" alt="School Photo">
                    <div class="slide-overlay"></div>
                    <div class="slide-content">
                        <h2>আধুনিক শিক্ষা</h2>
                ...
                <div class="slide">
                    <img src="/apex/assets/img/photo-2.jpg" alt="School Photo">
                    <div class="slide-overlay"></div>
                    <div class="slide-content">
                        <h2>সুন্দর পরিবেশ</h2>
                ...
                <div class="slide">
                    <img src="/apex/assets/img/photo-3.jpg" alt="School Photo">
                    <div class="slide-overlay"></div>
                    <div class="slide-content">
                        <h2>ভবিষ্যত নেতা</h2>
    ...
    <div class="notice-area ">
        ...
        <div class="scroll-box">
            <ul>
                <li><a href="/apex/admission.php"><i class="fa-solid fa-circle-arrow-right"></i> ভর্তি সম্পর্কে জানুন</a></li>
                <li><a href="/apex/routine.php"><i class="fa-solid fa-circle-arrow-right"></i> ক্লাস রুটিন ডাউনলোড করুন </a></li>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="notice-board-red clear">
                <div class="notice-red">
                    <ul>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="/apex/syllabus.php">সিলেবাস</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="/apex/routine.php">রুটিন</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="/apex/results.php">পরীক্ষার ফলাফল</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="/apex/holidays.php">ছুটির তালিকা</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="/apex/vacancies.php">শূন্যপদ</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="notice-board clear">
                <div class="notice-bg">
                    <h4 class="notice-title">অফিসিয়াল লিংক</h4>
                </div>
                <div class="notice-content">
                    <ul>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="https://apexmodelschool.vercel.app/">ওয়েবসাইট</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="https://www.facebook.com/profile.php?id=100082713758873">ফেসবুক পেজ</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="col-lg-9 col-md-9 col-sm-12">
            <div class="history-area clear ">
                ...
                <div class="notice-box">
                    <img  src="/apex/assets/img/photo-5.jpg" class="notice-img" alt="School History">
            ...
            <div class="speech-area clear">
                <div class="left-50">
                    ...
                    <div class="notice-box">
                        <img src="assets/img/Mehedi Hasan Milon.jpg" class="notice-img" alt="Principal">
                ...
                <div class="right-50">
                    ...
                    <div class="notice-box">
                        <img src="assets/img/photo.webp" class="notice-img" alt="Chairman">
            ...
            <div class="info-area clear">
                <div class="left-50">
                    <div class="student info">
                        ...
                        <div class="info-box">
                            <img src="assets/img/menu01.jpg" alt="Student Information">
                            <nav>
                                <ul>
                                    <li><i class="fa-solid fa-check"></i><a href="routine.php"> রুটিন</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="syllabus.php"> সিলেবাস</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="results.php"> পরীক্ষার ফলাফল</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="student_seats.php"> ছাত্রছাত্রীর আসন সংখ্যা</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    <div class="download info ">
                        ...
                        <div class="info-box">
                            <img src="assets/img/menu03.jpg" alt="Downloads">
                            <nav>
                                <ul>
                                    <li><i class="fa-solid fa-check"></i><a href="routine.php"> ক্লাস - পরীক্ষার রুটিন</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="syllabus.php"> ক্লাস সিলেবাস</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="admission.php"> ভর্তি তথ্য</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="right-50">
                    <div class="teacher info">
                        ...
                        <div class="info-box">
                            <img src="assets/img/menu02.jpg" alt="Teacher Information">
                            <nav>
                                <ul>
                                    <li><i class="fa-solid fa-check"></i><a href="teachers.php"> শিক্ষকবৃন্দ </a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="member.php"> কর্মকর্তা কর্মচারী </a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="vacancies.php"> শূন্যপদের তালিকা </a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    <div class="academic info">
                        ...
                        <div class="info-box">
                            <img src="assets/img/menu04.jpg" alt="Academic Information">
                            <nav>
                                <ul>
                                    <li><i class="fa-solid fa-check"></i><a href="classrooms.php"> কক্ষ সংখ্যা</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="holidays.php"> ছুটির তালিকা</a></li>
                                    <li><i class="fa-solid fa-check"></i><a href="student_seats.php"> ছাত্রছাত্রীর আসন সংখ্যা</a></li>
                                </ul>
                            </nav>
                        </div>
