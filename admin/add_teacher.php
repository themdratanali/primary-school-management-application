            ...
            <fieldset>
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" id="togglePassword" class="password-toggle" aria-label="Show password">
                        <!-- eye icon -->
                        <svg id="iconShow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <!-- eye-off icon (hidden) -->
                        <svg id="iconHide" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:none;">
