...
<body>
    <div class="container">
        <div class="page-title"><i class="fas fa-calendar"></i> Manage Routine</div>
        ...
        <div class="upload-section">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="e.g., Annual Routine 2026" required>
                </div>
                <div class="mb-3">
