...
$clean_photo = !empty($admin['photo']) ? preg_replace('#^\.\./#', '', $admin['photo']) : '';
$photo_url = (!empty($clean_photo) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/' . $clean_photo)) ? '../../' . $clean_photo : BASE_URL . '/uploads/images/logo.png';
?>
