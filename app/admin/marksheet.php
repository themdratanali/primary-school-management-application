...
$watermark_text = strtoupper($exam_type);
...
function calculateGrade($mark, $total_mark) {
    ...
    if ($percentage >= 90) return ['grade' => 'A+', 'point' => '5.00'];
    elseif ($percentage >= 80) return ['grade' => 'A', 'point' => '4.00'];
    elseif ($percentage >= 70) return ['grade' => 'A-', 'point' => '3.30'];
    elseif ($percentage >= 60) return ['grade' => 'B', 'point' => '3.00'];
    elseif ($percentage >= 50) return ['grade' => 'C', 'point' => '2.00'];
    elseif ($percentage >= 40) return ['grade' => 'D', 'point' => '1.00'];
    ...
    <div class="container-flex">
        <div class="form-container">
            <form method="get">
                ...
                <button type="button" class="generatebutton" style="margin-top: 10px; " onclick="downloadMarkSheet()">
        ...
        <?php if ($student && $results && $results->num_rows > 0): ?>
                <div class="admit-container">
                    ...
                    <div class="card-border">
                        <div class="header">
                            ...
                            <div class="header-center">
                                ...
                                <p class="admit-title">Mark Sheet</p>
                    ...
                    <div class="signature-section" style="margin-top: 60px; margin-bottom: 20px;">
                        <div class="signature-left">
                            <div class="signature-box" style="text-align: left; margin-top: 10px;">
                                <div style="border-top: 1px solid #000; padding-top: 5px; width: 150px;">
                                    <p style="margin: 0; font-size: 11px;">Student Signature</p>
                                </div>
                            </div>
                        </div>
                    <div class="signature-right" style="flex: 0 0 200px;">
