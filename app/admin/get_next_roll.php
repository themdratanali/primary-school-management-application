...
// Check CSRF token
if (!ams_csrf_is_valid($_POST['_token'] ?? '')) {
    http_response_code(403);
    echo 0;
    exit;
}

// Accept CSRF token via POST or check it's a valid session
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['batch_id'], $_POST['class_id'])) {
