...
<body>
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <?php
    $photoSrc = BASE_URL . '/uploads/students/default-photo.jpg';
    if (!empty($student['photo'])) {
        ...
        if (file_exists($fsPath)) {
            $photoSrc = BASE_URL . '/' . $cleanPath;
        }
    }
    ?>
    <img src="<?= htmlspecialchars($photoSrc) ?>" alt="Photo" width="150" style="border:1px solid #ccc; padding:5px;"><br>
