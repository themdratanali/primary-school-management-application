        ...
        <div class="form-container">
            ...
            <form method="post" id="feeForm">
                ...
                <div class="add-fee-section">
                    ...
                    <div style="margin-top: 15px; gap: 10px; align-items: center;">
                    ...
                    <div class="card-border">
                        <div class="header">
                            ...
                            <div class="header-center">
                                ...
                                <p class="header-sub">Kharkhari Bypass, Motihar, Paba, Rajshahi</p>
                                <p class="type-badge"><?php $receiptTypes = array_unique(array_column($_SESSION['fee_receipt'], 'fee_type_category')); echo implode(' + ', $receiptTypes); ?></p>
                                <p class="header-sub"><strong>Receipt No:</strong> <?= $_SESSION['receipt_id'] ?></p>
                            </div>
                            <?php
                            $photo = $student['photo'] ?? '';
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="amount-cell">৳<?= htmlspecialchars($item['amount']) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr class="total-row">
                        ...
                        <div class="signature-area" style="margin-top: 55px;">
                                    <p>________________________</p>
                                    <p style="font-weight: 400;font-size: 12px;">(Signature)</p>
                        ...
                        <div class="footer-note">
                            This is a computer-generated receipt. Please keep it safe for future reference.
                        </div>
                    </div>
                </div>
            </div>
