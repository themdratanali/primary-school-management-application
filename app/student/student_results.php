...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="<?php echo ams_student_url('results'); ?>" class="active">
                ...
                <div class="row">
                    <div>
                        <div class="class-select-box">
                            ...
                            <select name="class_id" class="form-select" onchange="window.location.href='student_results?batch_id=' + this.options[this.selectedIndex].getAttribute('data-batch') + '&class_id=' + this.value">
